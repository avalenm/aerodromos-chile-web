...
const PlayStoreBadge = ({ className = "" }: { className?: string }) => (
  ...
  >
    <svg viewBox="0 0 512 512" className="h-7 w-7" aria-hidden="true">
      ...
      <path
        fill="#FBBC04"
        d="m104.6 499 220.7-220.6-60.3-60.3L104.6 13z"
        opacity=".0"
      />
      <path fill="#EA4335" d="M104.6 13v486l220.7-220.6L104.6 13z" />
      <path
        fill="#4285F4"
        d="m104.6 13 280.8 161 60.1 60.3L104.6 499V13z"
        opacity="0"
      />
      <path
        fill="#FBBC04"
        d="M385.4 174 104.6 13v486l280.8-161 60.1-60.3z"
        opacity="0"
      />
      <path
        fill="#34A853"
        d="M104.6 13v486l220.7-220.6L104.6 13z"
        opacity="0"
      />
      <path
        fill="#FBBC04"
        d="m325.3 278.4 60.1 59.6 76.8-44c20.5-11.7 20.5-37.3 0-49L385.4 200l-60.1 78.4z"
      />
      <path
        fill="#4285F4"
        d="M104.6 499 325.3 278.4l-60.3-60.1L104.6 13c-7.4 4-12.4 11.5-12.4 21.4v443.2c0 9.9 5 17.4 12.4 21.4z"
      />
    </svg>
    <div className="text-left leading-tight">
      <div className="text-[10px] uppercase tracking-wider opacity-80">
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/70 backdrop-blur-xl">
        <div className="container mx-auto flex h-16 items-center justify-between">
          ...
          <Button
            asChild
            variant="default"
            className="bg-gradient-runway text-primary-foreground hover:opacity-90"
          >
        ...
        <div className="container relative mx-auto grid gap-12 py-20 md:grid-cols-2 md:py-28 lg:py-32">
          <div className="flex flex-col justify-center animate-fade-up">
            ...
            <h1 className="text-4xl font-bold leading-[1.05] tracking-tight md:text-6xl lg:text-7xl">
              Toda la aviación de{" "}
              <span className="text-gradient-runway">Chile</span> en tu bolso de
              vuelo.
            </h1>
          ...
          <div className="relative flex items-center justify-center">
            <div
              className="absolute inset-0 -z-10 animate-radar rounded-full opacity-60"
      ...
      <section id="features" className="container mx-auto py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Todo lo que necesitas saber de cada aeródromo de Chile, sin
            distracciones.
          </p>
        </div>
      ...
      <section
        id="screens"
        className="border-y border-border bg-secondary/30 py-24"
      >
        ...
        <div className="grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              Aeródromos Chile reúne en una sola app la información esencial de
              cada aeropuerto y aeródromo del país. La información ha sido
              obtenida desde el AIP Vol I y II de la D.G.A.C de Chile,
          ...
          <aside className="rounded-2xl border border-destructive/40 bg-destructive/10 p-6">
            ...
            <p className="mt-4 text-sm leading-relaxed text-foreground/90">
              <strong>
                Esta aplicación NO debe ser usada en operaciones aéreas.
              </strong>{" "}
              No la utilices para planificar tu vuelo: los datos pueden estar
              desactualizados o contener errores. Para planificación de vuelo
              utiliza siempre el AIP Vol I y II oficial.
            </p>
          </aside>
        </div>
      </section>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-card p-10 text-center md:p-16">
          ...
          <div className="relative">
            <img
              src={icon}
              alt=""
              className="mx-auto h-20 w-20 rounded-2xl shadow-glow"
            />
            <h2 className="mt-6 text-3xl font-bold tracking-tight md:text-5xl">
              Listo para despegar.
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Descarga Aeródromos Chile gratis en el App Store o Google Play y
              lleva la información de cada aeródromo del país en tu bolsillo.
            </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm">
              ...
              <div className="text-muted-foreground">
                © {new Date().getFullYear()} Alvaro Valenzuela
              </div>
            </div>
          </div>
          <a
